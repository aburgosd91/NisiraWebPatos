 ...
 */
@ManagedBean(name = "accionAction")
@SessionScoped
public class AccionesAction extends AbstactListAction<Acciones> implements Serializable {
    /* NOTAS:
        0-> Visualizar
        1-> Nuevo
        2-> Modificar
...
//            RequestContext.getCurrentInstance().update("dlgFormNuevoSucursal");
    ...
    public void eliminar() {
        try {
            ...
            Logger.getLogger(AccionesAction.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
