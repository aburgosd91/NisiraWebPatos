...
public class Menu_General implements Serializable {
    ...
    private String idUsuarioLogin = ((UsuarioBean) WebUtil.getObjetoSesion(Constantes.SESION_USUARIO)).getIDUSUARIO();
    ...
    public void llenarModulo() throws Exception {
        ...
        lista_tg30wbmodulo = new menuDao().buscar_tg30wbmodulo(idUsuarioLogin);
    }
    
    public void llenarSucursales() throws Exception {
        if(lista_sucursales == null){
            this.lista_sucursales = new ArrayList<String[]>();
            lista_sucursales = new menuDao().buscar_sucursal(idUsuarioLogin);
    ...
    public void llenarEmpresas() throws Exception {
        if(lista_empresas == null){
            ...
            lista_empresas = new menuDao().buscar_empresa(idUsuarioLogin);
