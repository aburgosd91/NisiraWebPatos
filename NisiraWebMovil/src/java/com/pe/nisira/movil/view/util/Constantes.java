...
public class Constantes {
    ...
    public static NumEmisor selectNumEmisor;
    public static Documento selectDocumento;
    public static Montacarga selectMontacarga;
    public static DMontacargaOperario selectDMontacargaOperario;
    public static DMontacargaEquipo selectDMontacargaEquipo;
    public static Equipo selectEquipo;
    
    public static Sucursal selectSucursal;
    public static Almacen selectAlmacen;
    public static Zona selectZona;
    public static GeneracionCodigo selectGeneracionCodigo; 
    public static Montacarga variableMontacarga;
    public static Plantilla variablePlantilla;
    public static Multitabla variableMultitabla;
     ...
     */
    public static GeneracionCodigo getSelectGeneracionCodigo() {
        return selectGeneracionCodigo;
    }

    /**
     * @param aSelectGeneracionCodigo the selectGeneracionCodigo to set
     */
    public static void setSelectGeneracionCodigo(GeneracionCodigo aSelectGeneracionCodigo) {
        selectGeneracionCodigo = aSelectGeneracionCodigo;
    }

   
    public static NumEmisor getSelectNumEmisor() {
        return selectNumEmisor;
    }

    public static void setSelectNumEmisor(NumEmisor selectNumEmisor) {
        Constantes.selectNumEmisor = selectNumEmisor;
    }

    public static Documento getSelectDocumento() {
        return selectDocumento;
    }

    public static void setSelectDocumento(Documento selectDocumento) {
        Constantes.selectDocumento = selectDocumento;
    }
    ...
    public static Montacarga getSelectMontacarga() {
        return selectMontacarga;
    }

    public static void setSelectMontacarga(Montacarga selectMontacarga) {
        Constantes.selectMontacarga = selectMontacarga;
    }

    public static DMontacargaOperario getSelectDMontacargaOperario() {
        return selectDMontacargaOperario;
    }

    public static void setSelectDMontacargaOperario(DMontacargaOperario selectDMontacargaOperario) {
        Constantes.selectDMontacargaOperario = selectDMontacargaOperario;
    }

    public static DMontacargaEquipo getSelectDMontacargaEquipo() {
        return selectDMontacargaEquipo;
    }

    public static void setSelectDMontacargaEquipo(DMontacargaEquipo selectDMontacargaEquipo) {
        Constantes.selectDMontacargaEquipo = selectDMontacargaEquipo;
    }
